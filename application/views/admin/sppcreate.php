...
<div class="container">
<form action="<?= base_url() ?>index.php/admin/spp/store" method="POST">
  <div class="mb-3">
	<br><br>
  ...
  <br>
    ...
    <input name="tahun" type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
  </div>
  <div class="mb-3">
